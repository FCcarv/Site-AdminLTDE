        ...
        <div class="col-md-12">
            ...
            <div class="box">
                ...
                <div class="col-md-offset-1 box-header with-border">
                    <h3 class="box-title"><i class="fa fa-list-ul"></i><strong>Postagens</strong></h3>
                    <a href="<?= BASEADMIN ?>post/add/" class="mailbox-attachment-name col-md-offset-8">
                        <i class="fa fa-link"></i> Cadastrar
                    </a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                            ...
                            <div class="col-md-5 crewell well-sm margin">
                                <div class="attachment-block clearfix">
                                    ...
                                    <div class="col-md-offset-2 product-info">
                                        <a href="javascript:void(0)" class="product-title"><h4><b><?=$p['title_post']?></b></h4></a>
