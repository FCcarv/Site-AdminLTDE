        ...
        <div class="col-md-12">
            ...
            <div class="box">
                ...
                <div class="col-md-offset-2 box-header with-border">
                    <h2><i class="fa fa-list-ul"></i>&nbsp;<strong>Categorias</strong></h2>
                </div>
                <div class="box-body">
                                ...
                                foreach ($listCatg as $categoria => $nome):
                                    ...
                                    <div class="box box-success box-solid">
                                        <div class="box-header with-border">
                                            <h2 class="box-title box-default"><i class="glyphicon glyphicon-signal"></i>&nbsp;&nbsp;<strong><?=$nome['title_categoria'];?></strong><span> ( 21 posts ) ( <?=$subCat?>  Categorias )</span></h2><br>
