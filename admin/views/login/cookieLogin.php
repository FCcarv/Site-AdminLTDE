...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= BASEADMIN ?>assets/css/f-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?= BASEADMIN ?>assets/css/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form class="form" method="post" id="login/log">
            <?php foreach($dados_form as $dado):?>
            <div class="form-group has-feedback">
                <input type="text" class="form-control"name="email_us" value="<?=$dado['email_us']?>" placeholder="Email">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name="pass_us" value="<?=$dado['pass']?>" placeholder="Password">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="remenber" value="<?=$dado['remenber']?>"> Lembrar-me
                        </label>
                    </div>
                </div>
                <?php endforeach;?>
